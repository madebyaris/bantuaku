...
- [x] Finalize architecture for vector DB, scraping, forecasting, and admin app (4h)
  ...
  - **Dependencies:** None
  - **Status:** ✅ Completed - Architecture decisions made: pgvector for vector DB, Go for scraping, Python microservice for forecasting, separate React admin app

## Phase 1: Data Model & Migrations (DB FOUNDATION)

- [x] Add pgvector extension and embedding schema (3h)
  ...
  - **Status:** ✅ Completed - Migration 004 created with pgvector extension and embeddings table

- [x] Create regulations knowledge base tables (4h)
  ...
  - **Status:** ✅ Completed - Migration 005 created with all regulations KB tables

- [x] Create Google Trends storage tables (3h)
  ...
  - **Dependencies:** None
  - **Status:** ✅ Completed - Migration 006 created with trends tables

- [x] Create forecasting and strategies tables (3h)
  ...
  - **Status:** ✅ Completed - Migration 007 created with forecasting and strategies tables

- [x] Create billing/subscription/admin RBAC tables (4h)
  ...
  - **Status:** ✅ Completed - Migration 008 created with RBAC, billing, and subscription tables
...
- [x] Forecasting service (12‑step horizon) (6h)
  ...
  - **Status:** ✅ Completed - Python FastAPI service created, adapter.go implemented, service.go with storage

- [x] Strategy generator per month (4h)
  ...
  - **Status:** ✅ Completed - generator.go implemented with rule-based strategy generation

- [x] API endpoints to retrieve forecasts + strategies (2h)
  ...
  - **Status:** ✅ Completed - forecasts_monthly.go handlers created, routes added to main.go

- [x] Scheduler for monthly updates + backfill (2h)
  ...
  - **Status:** ✅ Completed - forecast_scheduler.go implemented with monthly job and scheduling

## Phase 7: Admin Panel (Separate App) + Billing

- [x] Create separate admin frontend app (5h)
  ...
  - **Status:** ✅ Completed - Admin app created with React + Vite + Tailwind, matching main app design theme. Includes login, dashboard, user management, subscriptions, and audit logs pages. Dockerfile and docker-compose integration added.

- [x] Backend RBAC and admin endpoints (4h)
  ...
  - **Status:** ✅ Completed - RBAC middleware, admin handlers for users/subscriptions/audit logs, routes added

- [x] Stripe test mode integration (5h)
  ...
  - **Status:** ✅ Completed - Stripe service, checkout sessions, webhook handler, billing endpoints created

## Phase 8: Security, Observability, Testing

- [x] Audit logs and rate limiting (3h)
  ...
  - **Status:** ✅ Completed - Centralized audit logging service created, Redis-based rate limiting implemented for scraping/trends/admin endpoints, audit logging added to sensitive actions
...
- [ ] Update Docker Compose and envs (3h)
  ...
  - **Status:** ⏳ Pending - Docker Compose needs updates for forecasting service and pgvector
...
- [ ] Run and verify migrations (1h)
  ...
  - **Status:** ⏳ Pending - Migrations exist but need verification in staging environment
